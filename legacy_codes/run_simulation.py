...
class SigulatePickingEnv(object):
    def __init__(self):
        ...
        self.wait_timer = 0.0
        self.render_timer = self.render_freq(self, env, group, filter):lf.num_sub_iters, self.num_envs), dtype=np.float32)
...
if __name__ == '__main__':
    gym_handler = IsaacGymHandler()
    gym_handler.setup_envs()
    gym_handler.setup_camera()
    gym_handler.setup_objects()
    gym_handler.setup_grasps()
